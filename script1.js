...
//         await fetch("landing.html").then(response => response.text());

//     document.getElementById("authentication-container").innerHTML =
//         await fetch("authentication.html").then(response => response.text());

//     document.getElementById("role-container").innerHTML =
//         await fetch("role.html").then(response => response.text());

//     document.getElementById("customer-container").innerHTML =
//         await fetch("customer_dashboard.html").then(response => response.text());

//     document.getElementById("shop-container").innerHTML =
//         await fetch("shop_detail.html").then(response => response.text());

//     document.getElementById("barber-container").innerHTML =
//         await fetch("barber_dashboard.html").then(response => response.text());

//     document.getElementById("profile-container").innerHTML =
//         await fetch("profile.html").then(response => response.text());

//     document.getElementById("modals-container").innerHTML =
//         await fetch("modals.html").then(response => response.text());
// }
...
//     if (!response.ok) {
//         throw new Error(
//             fileName + " could not be loaded (" + response.status + ")"
//         );
//     }
